...
src/OSA_CAP/src/%.o: ../src/OSA_CAP/src/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -D__IPC__=0 -D__TRACK__=1 -D__MOVE_DETECT__=1 -I/usr/lib/aarch64-linux-gnu/include -I../src/OSA_IPC/inc -I/usr/include/opencv -I/usr/include/opencv2 -I/usr/include/GL -I../include -I../include/APP -I../include/dxutc -I../src/OSA_CAP/inc -O3 -Xcompiler -fopenmp -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_30,code=sm_30 -m64 -odir "src/OSA_CAP/src" -M -o "$(@:%.o=%.d)" "$<"
