...
static Int32 APP_start( int nType )
{
   ...
   // status = APP_startStop( nType, TRUE);
	...
	Dx_setTimer(ALG_TRACK_TIMER_ERRFEEDBACK,ALG_TRACK_TIMER_ERRFEEDBACK_TICKS);
...
static Int32 APP_stop( int item )
{
    ...
    Dx_killTimer(ALG_TRACK_TIMER_ERRFEEDBACK);
