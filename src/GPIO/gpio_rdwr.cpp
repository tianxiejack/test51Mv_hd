...
#define GPIO_NUMBER_MAX 500

#define GPIO_PIN_MAX		500
...
void GPIO_init()
{
	memset(gDirection,-1,sizeof(gDirection));
...
int GPIO_create(unsigned int num, unsigned int mode)
{
    ...
    {
        OSA_printf("gpio num out of range\r\n");
        return -1;
    }
...
int GPIO_set(UInt32 nPin, UInt32 nValue)
{
	...
	{
		OSA_printf("gpio nPin out of range\r\n");
		return -1;
	}
